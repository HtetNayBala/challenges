...
function showCard(x){
    $('#new-capital').html(`<h5 class="card-title mb-4" style="font-family: 'Noto Serif',Serif"> <p id="capital" class="fw-bold text-danger text-uppercase">${data[x].capital}</p> is the capital of </h5>`);
}
